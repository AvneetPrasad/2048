...
public class DrawUtils {
	...
	public static int getMessageHeight(String message, Font font, Graphics2D g) {
        ...
        /**
         * create a timer that counts once the game starts
         * @param millis
         * @return 
         */
	public static String formatTime(long millis) {
		...
		int hours = (int) (millis / 3600000); // hours
		if (hours >= 1) {
			millis -= hours * 3600000;
			formattedTime += hours + ":";
		}
		int minutes = (int) (millis / 60000); // mins
		if (minutes >= 1) {
		...
		int seconds = (int) (millis / 1000); // seconds 
		if (seconds >= 1) {
			millis -= seconds * 1000;
			if (seconds < 10) {
