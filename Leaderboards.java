...
/**
 * Contains the constructor for the
 *
...
public class Leaderboards {
    ...
    /**
     * adds score to the array if its higher than the minimum score and then
     * deletes the last score and shifts everything down 1
     *
     * @param score
     */
    ...
    /**
     * adds tile to the array if its higher than the minimum tile and then
     * deletes the last score and shifts everything down 1
     *
     * @param tileValue
     */
    ...
    /**
     * adds time to the array if its higher than the minimum time and then
     * deletes the last score and shifts everything down 1
     *
     * @param millis
     */
    ...
    /**
     * once the the game is reopen the score would present top 5 scores in the
     * leader board
     */
    ...
    /**
     * saves the scores of user in the save file
     */
