...
public class ScoreManager {
    ...
    /**
     * gets the file path that the project is in and creates a temp txt file
     * with the scores
     *
     * @param gBoard
     */
    ...
    /**
     * creates a new game and resets the current score and time on temp file
     */
    public void reset() {
    ...
    /**
     * creates a new temp file and writes all data initialized to 0
     */
    ...
    /**
     * saves the current and top scores and times as well as the game boards
     * tile configuration
     */
    ...
    /**
     * loads the data from the last unfinished game that is saved in temp and lets the user continue 
     * where they left off
     */
